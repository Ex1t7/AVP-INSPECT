    ...
    if (Serial.available() > 0) {
      ...
      if (command.startsWith("MOVE")) {
        ...
        if (action.equalsIgnoreCase("ENTER")) {
          ...
          Serial.println("Sending Fn+H (Go to Home View)...");
          ...
          Serial.println("Sending Fn+C (Open Control Centre)...");
          Keyboard.press(KEY_LEFT_GUI);
          Keyboard.press('c');
          delay(100);
          Keyboard.releaseAll();
          ...
          Serial.println("Sending Fn+N (Open Notification Centre)...");
          Keyboard.press(KEY_LEFT_GUI);
          Keyboard.press('n');
          delay(100);
          Keyboard.releaseAll();
          ...
          Serial.println("Opening Analytics...");
          Keyboard.press(KEY_LEFT_GUI);
          Keyboard.press(KEY_LEFT_SHIFT);
          Keyboard.press('.');
          delay(100);
          ...
          Serial.println("Toggling Pass-Through Mode...");
          Keyboard.press(KEY_LEFT_GUI);
          Keyboard.press(KEY_LEFT_SHIFT);
          Keyboard.press('p');
          delay(100);
          ...
          Serial.println("Moving to next item (Shift+Tab+Right Arrow)...");
          Keyboard.press(KEY_LEFT_SHIFT);
          Keyboard.press(KEY_TAB);
          Keyboard.press(KEY_RIGHT_ARROW);
          delay(100);
          ...
          Serial.println("Moving to previous item (Shift+Tab+Left Arrow)...");
          Keyboard.press(KEY_LEFT_SHIFT);
          Keyboard.press(KEY_TAB);
          Keyboard.press(KEY_LEFT_ARROW);
          delay(100);
          ...
          Serial.println("Opening Siri (Fn+S)...");
          Keyboard.press(KEY_LEFT_GUI);
          Keyboard.press('s');
          delay(100);
          Keyboard.releaseAll();
          ...
          Serial.println("Unknown KEYPRESS action. Use: ENTER, PLAYPAUSE, CTRLALTDELETE, TAB, SHIFTTAB, SPACE, FNH, FNC, FNN, TABH, GOBACK, CONTEXTMENU, ACTIONS, ANALYTICS, PASSTHROUGH, GESTURES, UP, DOWN, LEFT, RIGHT, MOVETOBEGIN, MOVETOEND, MOVETONEXT, MOVETOPREV, RESTART, SIRI, or ACCESSIBILITY.");
        }
      }
      else {
        Serial.println("Unknown command. Use: MOVE, SCROLL, CLICK, PRINT, WRITE, or KEYPRESS.");
      }
    }
  }
}
